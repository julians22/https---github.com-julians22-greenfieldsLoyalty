...
class UploadChart extends Component
{
    ...
    public function mount()
    {
        ...
        $users = Topup::select(DB::raw("COUNT(*) as count"), DB::raw("MONTH(created_at) as month"))
            ->whereYear('created_at', $currentYear)
            ->groupBy(DB::raw("MONTH(created_at)"))
            ->pluck('count', 'month');

        // Fill the $data array with counts for each month
    ...
    {
        return view('livewire.upload-chart');
    }
}
