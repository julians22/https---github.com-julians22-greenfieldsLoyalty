...
class UserService extends BaseService
{
    ...
    public function registerUser(array $data = [], $utm = false): User
    {
        ...
        try {
            ...
            $user->detail()->create([
                ...
                'date_of_birth' => $data['date_of_birth'] ?? null, //$data['child_date_of_birth'],
    ...
    public function store(array $data = []): User
    {
        ...
        try {
            ...
            throw new GeneralException(__('There was a problem creating this user. Please try again.') . $e->getMessage());
        }
