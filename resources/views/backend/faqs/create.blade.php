...
@section('content')
    <x-forms.post :action="route('admin.faq.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create New Faq')
            </x-slot>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="question" id="question" rows="2" class="form-control">{{ old('question') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="answer" id="answer" rows="10" class="form-control">{!! old('answer') ?? 'Insert answered question' !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Create Faq')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
