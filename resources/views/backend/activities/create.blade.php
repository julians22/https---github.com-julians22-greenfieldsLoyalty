...
@section('title', __('Create New Activity'))

@section('content')
    <x-forms.post :action="route('admin.activity.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create New Activity')
            </x-slot>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="content" id="content" rows="2" class="form-control">{{ old('content') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" id="thumbnail_image" name="thumbnail_image" value="{{ old('thumbnail_image') }}" class="form-control" readonly placeholder="" aria-label="Image" aria-describedby="lfm">
                            ...
                            <div id="thumbnailImageholder" class="preview-image-wrapper" data-url="{{ old('image') }}"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <label class="c-switch c-switch-pill c-switch-label c-switch-success">
                                    <input type="checkbox" name="publish" class="c-switch-input">
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Create Activity')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
