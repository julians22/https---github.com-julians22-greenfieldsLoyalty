...
@section('content')
    <x-forms.patch :action="route('admin.banner.update', ['banner' => $banner])">
        <x-backend.card>
            <x-slot name="header">
                @lang('Edit Banner')
            </x-slot>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input required type="text" id="desktopBanner" name="desktopBanner" value="{{ old('desktopBanner') ?? $banner->image['desktopBanner'] }}" class="form-control" placeholder="" aria-label="Image" readonly aria-describedby="lfm">
                            ...
                            <div id="desktopBannerholder" class="preview-image-wrapper" data-url="{{ old('desktopBanner') ?? $banner->image['desktopBanner'] }}"></div>
                        </div>
                        <div class="form-group">
                            <label for="name">@lang('Mobile Banner Image')</label>
                            <small class="text-success">Image Size: 200 × 200 px</small>
                            <div class="input-group mb-3">
                                <input required type="text" id="mobileBanner" name="mobileBanner" value="{{ old('mobileBanner') ?? $banner->image['mobileBanner'] }}" class="form-control" placeholder="" aria-label="Image" readonly aria-describedby="lfm">
                                <div class="input-group-append">
                            ...
                            <div id="mobileBannerholder" class="preview-image-wrapper" data-url="{{ old('mobileBanner') ?? $banner->image['mobileBanner'] }}"></div>
                        </div>
                    </div>
                </div>
